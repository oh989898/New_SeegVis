...
function  linechart(data,signal,lens,nwd,wd,twoElectCo,statistic) {
    ...
    */
    ...
    svg.selectAll("dot")
        ...
        .enter().append("circle")
        .attr("r", function (d) {
            return y_lag(Math.abs(d.lag)*1.5);
        })
        .attr("fill", function (d) {
            if (d.lag > 0) return "#FFB64C";
            if (d.lag == 0) return "white";
            if (d.lag < 0) return "#FF6086";
        })
        .attr("cx", function (d) {
            return x(d.time);
        })
    ...
    */
    ...
    table.attr("style","margin-right:auto; margin-left:auto; display:block ");
...
function violinBwt() {
    ...
    var max_y = max_h2 > 1 ? 1 : max_h2;
      ...
      var mynewcolors = ["#FF6086","#FFB64C","#009BAD","#FFD0DA","#FFE9C7","#AEE1E6"];
    ...
    chartButton.append("button")
        ...
        .on("click",function () {
            ...
            $("#加权按钮").removeClass().addClass("button2");
            $("#非加权按钮").removeClass().addClass("button");
        });
    ...
    chartButton.append("button")
        ...
        .on("click",function () {
            ...
            directionality(3);
            $("#非加权按钮").removeClass().addClass("button2");
            $("#加权按钮").removeClass().addClass("button");
        });
    chartButton.append("button")
        .attr("class","button")
        .attr("title","取消视图")
...
function directionality(type) {
    ...
    var svg = direction
      ...
      var myColorViolin = d3.scaleOrdinal()
        .domain(d3.range(0,6))  //  x.domain()获取x定义域的值
        .range(["#FF6086","#FFB64C","#009BAD","#FFD0DA","#FFE9C7","#AEE1E6"]);
      var count=0;
      // directionByType={};
...
function stream_out_in(data,electrode_names,time,step) {
    ...
    */
    ...
    var myChart = echarts.init(dom,"essos");
    var option = {
        /*
        title: {
            text: type,
